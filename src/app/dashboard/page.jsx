...
import DualLineComparisonWidget from '@/components/dashboard/widgets/DualLineComparisonWidget';
import PostStatusStackedWidget from '@/components/dashboard/widgets/PostStatusStackedWidget';
import { 
  StatPostsWidget, StatViewsWidget, StatCommentsWidget, StatCategoriesWidget, 
  StatSubscribersWidget, StatWhatsappWidget, StatUsersWidget, StatThemeWidget, 
  StatPluginsWidget, StatPagesWidget, StatScheduledWidget,
  ArticleManagementWidget, SeoSummaryWidget, RecentActivityWidget, 
  RecentCommentsWidget, SystemStatusWidget 
} from '@/components/dashboard/widgets/GenericWidgets';
import { 
  ChartTopPostsHBarWidget, ChartSpeedometerGaugeWidget, ChartViewsTrendWidget, 
  ChartVisitorsAreaWidget, ChartSeoKeywordsDonutWidget, ChartSystemRadarWidget, 
  ChartSparklinesGridWidget, ChartHourlyHeatmapWidget, ChartCategoryDistributionWidget 
} from '@/components/dashboard/widgets/ChartWidgets';
import { TableCommentsModerationWidget, TableSeoArticlesWidget } from '@/components/dashboard/widgets/TableWidgets';
...
export default function DashboardOverview() {
  ...
  const renderWidgetContent = (id) => {
    switch (id) {
      ...
      case 'stat_posts':
        return <StatPostsWidget analytics={analytics} t={t} />;
      case 'stat_views':
        return <StatViewsWidget analytics={analytics} t={t} />;
      case 'stat_comments':
        return <StatCommentsWidget analytics={analytics} t={t} />;
      case 'stat_categories':
        return <StatCategoriesWidget analytics={analytics} t={t} />;
      case 'stat_subscribers':
        return <StatSubscribersWidget subscribersCount={subscribersCount} pluginStates={pluginStates} t={t} />;
      case 'stat_whatsapp':
        return <StatWhatsappWidget pluginStates={pluginStates} t={t} />;
      case 'stat_users':
        return <StatUsersWidget t={t} />;
      case 'stat_theme':
        return <StatThemeWidget t={t} />;
      case 'stat_plugins':
        return <StatPluginsWidget pluginStates={pluginStates} t={t} />;
      case 'stat_pages':
        return <StatPagesWidget pagesCount={pagesCount} t={t} />;
      case 'stat_scheduled':
        return <StatScheduledWidget scheduledCount={scheduledCount} t={t} />;
      
      // CHARTS
      case 'chart_traffic_source_pie':
        return <TrafficSourcePieWidget analyticsSeries={analyticsSeries} />;
      case 'chart_top_posts_hbar':
        return <ChartTopPostsHBarWidget recentPosts={recentPosts} t={t} />;
      case 'chart_dual_line_comparison':
        return <DualLineComparisonWidget analyticsSeries={analyticsSeries} recentPosts={recentPosts} />;
      case 'chart_post_status_stacked':
        return <PostStatusStackedWidget recentPosts={recentPosts} />;
      case 'chart_speedometer_gauge':
        return <ChartSpeedometerGaugeWidget recentPosts={recentPosts} t={t} />;
      case 'chart_views_trend':
        return <ChartViewsTrendWidget analyticsSeries={analyticsSeries} language={language} t={t} />;
      case 'chart_visitors_area':
        return <ChartVisitorsAreaWidget analyticsSeries={analyticsSeries} t={t} />;
      case 'chart_seo_keywords_donut':
        return <ChartSeoKeywordsDonutWidget recentPosts={recentPosts} pluginStates={pluginStates} t={t} />;
      case 'chart_system_radar':
        return <ChartSystemRadarWidget recentPosts={recentPosts} t={t} />;
      case 'chart_sparklines_grid':
        return <ChartSparklinesGridWidget analyticsSeries={analyticsSeries} recentPosts={recentPosts} recentComments={recentComments} t={t} />;
      case 'chart_hourly_heatmap':
        return <ChartHourlyHeatmapWidget analyticsSeries={analyticsSeries} language={language} t={t} />;
      case 'chart_category_distribution':
        return <ChartCategoryDistributionWidget recentPosts={recentPosts} t={t} />;
      
      // TABLES
      case 'table_comments_moderation':
        return <TableCommentsModerationWidget recentComments={recentComments} showToast={showToast} t={t} />;
      case 'table_seo_articles':
        return <TableSeoArticlesWidget recentPosts={recentPosts} t={t} />;
      
      // OTHER
      case 'article_management':
        return <ArticleManagementWidget t={t} />;
      case 'seo_summary':
        return <SeoSummaryWidget t={t} />;
      case 'recent_activity':
        return <RecentActivityWidget recentPosts={recentPosts} t={t} />;
      case 'recent_comments':
        return <RecentCommentsWidget recentComments={recentComments} t={t} />;
      case 'system_status':
        return <SystemStatusWidget t={t} />;
      default:
        return null;
    }
  };
